...
struct CheckoutViewPro10: View {
    @State var order: OrderPro10
    ...
    func placeOrder() async{
        ...
        do{
            ...
            let decodedOrder = try JSONDecoder().decode(OrderPro10.self, from: data)
            confirmationMessage = "Your order for \(decodedOrder.quality)x \(OrderPro10.types[decodedOrder.type].lowercased()) cupcakes is on its way!"
...
#Preview {
    CheckoutViewPro10(order: OrderPro10())
}
